...
class engineerperspectiveController extends Zend_Controller_Action
{
	private $_user_session;
	private $_controller_default_perspective = 4;
	...
	{
		$this->_helper->viewRenderer->setNoRender(true);
		echo $this->view->action('endusersearch','enduser', null);
	}
	
	public function endusercurrentservicesAction()
	{
		$this->_helper->viewRenderer->setNoRender(true);
		echo $this->view->action('currentservices','enduser', null);
	}
	
	public function equipmentinventoryAction()
	{
		$this->_helper->viewRenderer->setNoRender(true);
		echo $this->view->action('equipmentininventory','inventory', null);
	}
